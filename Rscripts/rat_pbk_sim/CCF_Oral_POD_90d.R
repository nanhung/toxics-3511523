# CCF_Oral_POD_90d
# Parameter settings are based on DLM
# No isomer composition different due to the data limitation
...
source("Rscripts/rat_pbk_sim/CYF_params_Oral_90d.R")

# ORAL and IV
params[["PDOSE"]] <- 1.22*0.4 # BBMD BMDL
