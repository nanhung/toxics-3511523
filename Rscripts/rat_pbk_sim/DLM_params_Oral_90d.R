...
# Description of the parameters used in the PBPK model for DLM for PND90 rats.

params <- c(
  BODYWT = 0.3517, 	 #body weight (kg)
  MW = 505,      		 #molecular weight for DLM  (g/mole)  
  ...
  PADIP= 68.7,   		 #fat PC
  PLIV = 1.71,    	 #liver PC
  PRP = 1.71, #1.71,       #rapidly-perfused tissue PC
