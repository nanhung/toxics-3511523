# This code is to simulate trans-PRM dose metrics in PND90 
...
source("Rscripts/rat_pbk_sim/TPM_params_Oral_90d.R")

# ORAL and IV
params[["PDOSE"]] <- 39.17 * 0.6 # BBMD BMDL
...
state <- c(ODOSE=0, IVSWITCH=0, AORAL=0, AIV=0, AVE=0, ALU=0, AFEC=0, ACYP=0, ACAE=0, ACAEP=0, AGI=0, AL=0, AVF=0,
           AF=0, ARP=0, AVSP=0, ASP=0, AVB=0, AB=0, APLS=0, AUCBRAIN=0, AUCLIVER=0, AUCADIPOSE=0, AUCBLOOD=0, AUCRBC=0)
