...
# WTSPP2YR - Full Sample 4 Year MEC Exam Weight
...
#- URXCB3 (99-00, 01-02, 07-08, 09-10)
#- URXCCC (99-00, 01-02)
  ...
  for (i in 1:length(samps)) {
    ...
    for (j in 1:length(result[[i]])) {
        ...
        if (is.null(save_directory)){
          ...
          print(
            paste("https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/", ref$Full[indP], "/DataFiles/", result[[i]][j], sep = "")
            )
...
get_data <- function(cohort = "99-00"){
  get_NHANES_data(codes_file = "NHANEScodes_file.xlsx",
                  cohort = cohort,
                  save_directory = "saves")
}

years <- c("1999-2000", "2001-2002", "2007-2008", "2009-2010", 
           "2011-2012", "2013-2014", "2015-2016")
cohort <- c("99-00", "01-02", "07-08", "09-10", "11-12", "13-14", "15-16")

for(i in seq(7)) {
  check_files <- list.files(paste0("saves/rawData/", years[i], "/"))
...
for (j in c(5:7)){
  ...
  locat <- paste0("saves/rawData/", years[j])
  demo_locat <- paste0(
