...
\Author{Nan-Hung Hsieh*\orcidA{} and Eric S.C. Kwok}
...
\AuthorCitation{Hsieh, N.-H.; Kwok, S.C.E.}
...
disease \citep{park2019environmental, bao_association_2020,
...
Biomonitoring data in the U.S. population, extensively tracked by the National
Health and Nutrition Examination Survey (NHANES) over decades. A landmark study
by \citet{barr2010urinary} analyzed data from the NHANES collected between 1999
and 2002.They detected 3PBA in more than 70\% of over 5,000 participants, with
geometric mean concentrations of 0.29 ng/mL in adults and 0.41 ng/mL in
children, indicating that children may experience higher pyrethroid exposure.
An observational study by \citet{morgan2007observational} focused on 127
preschool children at homes and daycare centers in 6 Ohio counties. Their study
found 3PBA in 67\% of urine samples (median: 0.3 ng/mL; maximum: 33.8ng/mL).
The permethrin was detected most often in the dust (100\%) and hand wipe
(>78\%) samples. Similarly, \citet{trunnelle2014urinary} studied 83 California
children aged 2-8 near agricultural areas, reporting a 60 \% detection rate of
3PBA (median: 0.75 ng/mL, with proximity to fields as a significant exposure
factor. However, biomonitoring data alone have limitations in exposure
assessment due to factors such as variable exposure frequency, sampling time,
and inter-individual variability \citep{aylward2017variation}. Despite the
limitations, biomonitoring data can be used with computational exposure
modeling tools in exposure reconstruction.
...
The PBK model builds on the comprehensive sensitivity analysis reported in 
\citet{mallick2020development}. The study identified the brain partition coefficient and
unbound fraction in plasma as the most sensitive parameters affecting
...
In the present research, we adopted these previously validated parameters,
...
studies that substantiate this finding (e.g., \citep{barr2010urinary}). 2)The
...
capture exposure trends, likely due to its simplified structure and omission of
...
half of the metabolites increase the uncertainty and challenge of exposure
prediction. 3) Compared to the high-throughput approach, the PBK model offers
detailed insights by integrating systematic exposure data, providing more
robust information for exposure risk assessment.
