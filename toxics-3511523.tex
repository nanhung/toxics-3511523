...
\Title{Biomonitoring Data-Driven Exposure Risk Assessment for Pyrethroids Pesticides in the U.S. Population: Integrated Application of High-Throughput and Physiologically Based Toxicokinetic Approaches}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Biomonitoring Data-Driven Exposure Risk Assessment for Pyrethroids Pesticides in the U.S. Population: Integrated Application of High-Throughput and Physiologically Based Toxicokinetic Approaches}
...
\Author{Nan-Hung Hsieh $^{1}$*\orcidA{} and Eric S. Kwok $^{1}$}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Nan-Hung Hsieh and Eric S. Kwok}
...
\address{%
$^{1}$ \quad Human Exposure \& Health Effects Modeling Section, Human
Health Assessment Branch, Department of Pesticide Regulation, California
...
% Keywords
\keyword{Reverse dosimetry; Biomonitoring; High-throughput model;
Physiologically based kinetic model; Pyrethroids}
...
Pesticide Regulation. The authors want to thank staff member,
Dr.~Shelley DuTeaux and Dr.~Gayatri Sankaran, for providing helpful
comments.}
