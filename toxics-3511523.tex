...
% Keywords
\keyword{Reverse dosimetry; Bayesian; Pyrethroids; Urinary metabolites,
Exposure risk}
...
\centering
\includegraphics[width=\linewidth]{figures/fig3_goodness}
\hfill
\end{adjustwidth}
...
(\url{https://www.cdc.gov/nchs/nhanes}). The prediction from high-throughput
reverse dosimetry model can be found in the U.S.EPA GitHub repository
(\url{https://github.com/USEPA/CompTox-HumanExposure-bayesmarker}).  The
Bayesian BMD analysis and results are also available for deltamethrin
(\url{https://benchmarkdose.com/run/d29c89e5-1ac9-4408-8788-806cf924f615/}),
$\beta$-Cyfluthrin
(\url{https://benchmarkdose.com/run/de55bf8c-0c2e-4b78-9040-cc1930e2506d/}),
cypermethrin
(\url{https://benchmarkdose.com/run/95f15b77-b36f-4714-80bc-846ad2127049/}),
and permethrin
(\url{https://benchmarkdose.com/run/2b98df53-151c-403e-8301-07972703eaa9/}).
All data and code for modeling and analysis in this study is publicly available
at (\url{https://github.com/nanhung/toxics-3511523}). }
...
\begin{figure}[H]
\begin{adjustwidth}{-4cm}{}
\includegraphics[width=\linewidth]{figures/figa1_ecdf}
\hfill
\end{adjustwidth}
...
\begin{figure}[H]
\begin{adjustwidth}{-4cm}{}
\includegraphics[width=\linewidth]{figures/figa2_evaluation}
\hfill
\end{adjustwidth}
