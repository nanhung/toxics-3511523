...
%=================================================================
\documentclass[toxics,article,accept,pdftex,moreauthors]{Definitions/mdpi} 
...
\datereceived{18 February 2025} 
\daterevised{10 March 2025} % Comment out if no revised date
...
\Title{Biomonitoring-Based Risk Assessment of Pyrethroid Exposure in the U.S. Population: Application of High-Throughput and Physiologically Based Kinetic Models} 

% MDPI internal command: Title for citation in the left column
\TitleCitation{Biomonitoring-Based Risk Assessment of Pyrethroid Exposure in the U.S. Population: Application of High-Throughput and Physiologically Based Kinetic Models}
...
\Author{\hl{Nan-Hung} %MDPI: Please carefully check the accuracy of names and affiliations. REPLY: Confirm.
 Hsieh *\orcidA{} and \hl{Eric} %MDPI: The name of this author is different from the one submitted online at susy.mdpi.com. Please confirm which one is correct. REPLY: Confirm the name.
 \hl{S. C.} %MDPI: We added a space between the middle names. Please confirm. REPLY: Confirm.
 Kwok}
...
\AuthorCitation{Hsieh, N.-H.; Kwok, E.S.C.}
...
Protection Agency, Sacramento, \hl{CA 95814,} %MDPI: Please add the postal code (or ZIP code in the U.S.). If the postal code is not available, Post Office Box number can be added instead. REPLY: Added.
USA; \hl{eric.kwok@cdpr.ca.gov (E.S.C.K)} %MDPI: We added the email address here according to this submitted online at susy.mdpi.com. Please confirm. REPLY: Confirm.
\\ }

% Contact information of the corresponding author
%\corres{Correspondence: e-mail@e-mail.com; Tel.: (optional; include country code; if there are multiple corresponding authors, add author initials) +xx-xxxx-xxx-xxxx (F.L.)}
\corres{\hangafter=1 \hangindent=1.05em \hspace{-0.82em} Correspondence: mailto:nan-hung.hsieh@cdpr.ca.gov}
...
agriculture and residential areas in the United States. This study
evaluated the exposure risk by age using available biomonitoring data. 
We analyzed pyrethroid metabolite concentrations in
...
Bayesian inference framework. We further derived Benchmark Dose (BMD)
values and systemic points of departure in rats using Bayesian BMD and
PBK models. Margins of exposure (MOE) were calculated to assess
neurotoxic risk based on estimated daily oral intake and dose metrics in
plasma and brain. Results from both models indicated that young children have
higher pyrethroid exposure compared to other age groups. All estimated
risk values were within acceptable levels of acute neurotoxic effect.
...
associated with pyrethroid exposures, demonstrating their potential for
future applications in exposure tracking and health risk assessment.}

% Keywords
\keyword{\highlighting{reverse} %MDPI: We changed the first letter of the keywords to lowercase, please confirm REPLY: Confirm.
 dosimetry; bayesian; pyrethroids; urinary metabolites;
exposure risk}
...
between 1999 and 2002. The~analysis showed that 3PBA was detected in more than 70\% of the over \hl{5000} %MDPI: Commas are only used for numbers with five or more digits. We removed them in four-digit numbers. Please confirm. REPLY: Confirm. 
...
\begin{itemize}
\item
  \hl{Model Specification:} %MDPI: Please confirm if the bold is unnecessary and can be removed. Please check the full text REPLY: Removed.
...
\includegraphics[width=0.8\linewidth,]{figures/fig2_pbk} \caption{\hl{Refined} %MDPI: Please confirm if the explanation of the arrow needs to be added in the figure caption> REPLY: Add corresponding open access reference to explain.
...
\subsection{Bayesian~Population modeling}\label{bayesian-population-modeling} % Revised the misspelling word
...
\hl{database} %MDPI: Please provide the access date of the URL in the following format: "URL (accessed on Day Month Year)". REPLY: Added.
...
Exposure predictions from the U.S. EPA CompTox Chemicals \hl{Dashboard} %MDPI: Please provide the access date of the URL in the following format: "URL (accessed on Day Month Year)". REPLY: Added.
...
\subsection{Bayesian Benchmark Dose~Modeling}\label{bayesian-benchmark-dose-modeling} %REPLY: Revise the misuse of section
...
\hfill
\end{adjustwidth}
\caption{\hl{Goodness--of--fit} %MDPI: 1. Please change the hyphen (-) into an endash sign (--, "U+2013"). e.g., "15-16" should be "15--16".  2. \hl{} %MDPI: Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". 3. Please confirm if the explanation of the colors needs to be added in the figure caption. REPLY: Changed the hyphen to endash sign. The color had explained in the figure legend. The NHANES cohort and age were changed to endash based on the suggestion. The minus sign were changed for numerical expression.
...
\hfill
\end{adjustwidth}
\caption{\hl{Comparison} %MDPI: 1. Please change the hyphen (-) into an endash sign (--, "U+2013"). e.g., "6-11" should be "6--11".  2. \hl{} %MDPI: Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1". REPLY: Conformed.
...
%\hfill
\end{adjustwidth}
\caption{\hl{Variability} %MDPI: 1. Please change the hyphen (-) into an endash sign (--, "U+2013"). e.g., "6-11" should be "6--11". 2. In order to reduce page blank space, we moved the figure here, please confirm REPLY: Confirm.
...
%\hfill
\end{adjustwidth}
\caption{\hl{Trends} %MDPI: Please change the hyphen (-) into an endash sign (--, "U+2013"). e.g., "6-11" should be "6--11".
...
%\hfill
\end{adjustwidth}
\caption{\hl{Exposure} %MDPI: 1. Please change the hyphen (-) into an endash sign (--, "U+2013"). e.g., "6-11" should be "6--11". 2. Some numbers in the picture are blocked and not fully displayed. Please modify it. REPLY: Updated.
...
\textls[-25]{For cis-cypermethrin, the~plasma Cmax and AUC were 152.2 ng/mL and
1510.8~ng-h/mL,} while brain values were 43.7 ng/g and 611.2 ng-h/g. For~trans-cypermethrin, the~plasma Cmax and AUC were 210.4 ng/mL and 2087.9
...
N.-H.H.; validation, N.-H.H.; formal analysis, N.-H.H.; investigation, N.-H.H.;
resources, N.-H.H.; data curation, N.-H.H.; writing---original draft preparation,
N.-H.H.; writing---review and editing, E.S.C.K.; visualization, N.-H.H.;
supervision, E.S.C.K.; project administration, E.S.C.K. All authors have read
and agreed to the published version of the~manuscript.}

\funding{This research received no funding from any~sources.}
...
Centers for Disease Control and Prevention's \hl{website} %MDPI: Please provide the access date of the URL in the following format: "URL (accessed on Day Month Year)".
(\url{https://www.cdc.gov/nchs/nhanes}; accessed on 03/03/2023). The~prediction from high-throughput
reverse dosimetry model can be found in the U.S.EPA GitHub repository
(\url{https://github.com/USEPA/CompTox-HumanExposure-bayesmarker}; accessed~on 1 January 2023).
The~Bayesian BMD analysis and results are available for deltamethrin
(\url{https://benchmarkdose.com/run/d29c89e5-1ac9-4408-8788-806cf924f615/}, accessed~on 15 March 2025),
$\beta$-Cyfluthrin
(\url{https://benchmarkdose.com/run/de55bf8c-0c2e-4b78-9040-cc1930e2506d/}, accessed~on 15 March 2025),
cypermethrin
(\url{https://benchmarkdose.com/run/95f15b77-b36f-4714-80bc-846ad2127049/}, accessed~on 15 March 2025),
and permethrin
(\url{https://benchmarkdose.com/run/2b98df53-151c-403e-8301-07972703eaa9/}, accessed~on 15 March 2025).
All data and code for modeling and analysis in this study is publicly available
at (\url{https://github.com/nanhung/toxics-3511523}, accessed~on 15 March 2025). }
...
Pesticide Regulation. The~authors \hl{thank} %MDPI: Titles (e.g., Dr., Mr., and Prof.) should NOT be used in the Acknowledgments section. We removed them. Please confirm. REPLY: Confirm.
Shelley DuTeaux and
~Gayatri Sankaran for their thorough internal reviews of the manuscript. We also thank anonymous reviewers for their valuable comments.}

\conflictsofinterest{The authors declare no competing interests. The~views expressed in this article are those of the authors and do not
...
RfD & \hspace*{0.95em} Reference Dose \\
SHEDS & \hspace*{0.95em} Stochastic Human Exposure and Dose Simulation \\
TD & \hspace*{0.95em} Toxicodynamics \\
TK & \hspace*{0.95em} Toxicokinetics \\
USDA & \hspace*{0.95em} United States Department of Agriculture
\end{tabular}
}
...
\vspace{-6pt}\begin{table}[H]

  \caption{Measured pyrethroids metabolites and the limits of detection ($\upmu$g/L) across each NHANES~cycle.}
\label{tab:taba1}
%\begin{adjustwidth}{-4cm}{}
\begin{adjustwidth}{-\extralength}{0cm}
...
\toprule
  & \textbf{1999--2000} & \textbf{2001--2002} & \textbf{2007--2008} & \textbf{2009--2010} & \textbf{2011--2012} & \textbf{2013--2014} & \textbf{2015--2016}\\
\midrule
...
\toprule
  & \textbf{3PBA} & \textbf{FPBA} & \textbf{DBCA} & \textbf{cis-DCCA} & \textbf{Trans-DCCA}\\
\midrule
Cyfluthrin &  & x &  & x & x\\
Cypermetrhin & x &  &  & x & x\\
Deltamethrin & x &  & x &  & \\
...
\begin{adjustwidth}{-\extralength}{0cm}
\setlength{\tabcolsep}{4.48mm}{
\begin{tabular}{lllrr}
\toprule
\textbf{Parameter} & \textbf{Description} & \textbf{Unit} & \textbf{Value} & \textbf{Reference}\\
\midrule
...
\begin{table}[H]
%\begin{adjustwidth}{-4cm}{}
\caption{\label{tab:taba4}\textls[-15]{Distribution of PBK parameters used in Monte Carlo simulation for exposure risk~assessment.}}

%\begin{adjustwidth}{-\extralength}{0cm}
\setlength{\tabcolsep}{3.2mm}{
\begin{tabular}[t]{lccc}
\toprule
\textbf{Parameter Type} & \textbf{No. of Parameter} & \textbf{SD} & \textbf{Truncation (±nxSD)}\\
\midrule
...
%\hfill
\end{adjustwidth}
\caption{\hl{Cumulative} %MDPI: 1. Please change the hyphen (-) into a minus sign ($-$, "U+2212"). e.g., "-1" should be "$-$1".  2. Please change the hyphen (-) into an endash sign (--, "U+2013"). e.g., "6-11" should be "6--11". REPLY: Confirm.
...
%\begin{adjustwidth}{-4cm}{}
\begin{adjustwidth}{-\extralength}{0cm}
~~~\includegraphics[width=0.97\linewidth]{figures/figa2_evaluation}
%\hfill
\end{adjustwidth}
\caption{\textls[-25]{\hl{Evaluation} %MDPI: Please comfirm if the format of "Author+Year" in the image is ref, citation, if so, please cite all mentioned references in the caption. REPLY: Added.
  of model performance of refined PBK model with human toxicokinetic~experiments \citep{leng1997biological, woollen_metabolism_1992, ratelle2015toxicokinetics, ratelle2015time, sam2012biological}.}}\label{fig:figa2}
\end{figure}
...
\bibitem[Burns and Pastoor(2018)]{burns2018pyrethroid}
Burns, C.J.; Pastoor, T.P.
\newblock Pyrethroid epidemiology: A quality-based review.
\newblock {\em Crit. Rev. Toxicol.} {\bf 2018}, {\em 48},~297--311.

\bibitem[Park et~al.(2019)Park, Park, and Choi]{park2019environmental}
Park, J.; Park, S.K.; Choi, Y.H.
\newblock Environmental pyrethroid exposure and diabetes in US adults.
\newblock {\em Environ. Res.} {\bf 2019}, {\em 172},~399--407.

\bibitem[Bao et~al.(2020)Bao, Liu, Simonsen, and Lehmler]{bao2020association}
...
\newblock {\em JAMA Intern. Med.} {\bf 2020}, {\em 180},~367--374.

\bibitem[Kim et~al.(2021)Kim, Hong, and Choi]{kim2021environmental}
...
\newblock {\em Int. J. Environ. Res. Public Health} {\bf 2021}, {\em 18},~12005.

\bibitem[Zartarian et~al.(2012)Zartarian, Xue, Glen, Smith, Tulve, and
  Tornero-Velez]{zartarian2012quantifying}
...
\newblock {\em J. Expo. Sci. Environ. Epidemiol.} {\bf
  2012}, {\em 22},~267--273.

\bibitem[Bravo et~al.(2022)Bravo, Gar{\'\i}, and
  Grimalt]{bravo2022occupational}
...
\newblock {\em Environ. Res.} {\bf 2022}, {\em 214},~114186.

\bibitem[Tulve et~al.(2011)Tulve, Egeghy, Fortmann, Xue, Evans, Whitaker, and
  Croghan]{tulve2011methodologies}
...
\bibitem[Xue et~al.(2014)Xue, Zartarian, Tornero-Velez, and Tulve]{xue2014epa}
...
\newblock {\em Environ. Health Perspect.} {\bf 2000}, {\em
  108},~505--514.

\bibitem[Xue et~al.(2015)Xue, Zartarian, Mintz, Weber, Bailey, and
  Geller]{xue2015modeling}
...
\newblock {\em Sci. Total Environ.} {\bf 2015}, {\em
  533},~102--109.

\bibitem[Zartarian et~al.(2017)Zartarian, Xue, Tornero-Velez, and
  Brown]{zartarian2017children}
Zartarian, V.; Xue, J.; Tornero-Velez, R.; Brown, J.
\newblock Children’s lead exposure: A multimedia modeling analysis to guide
  public health decision-making.
\newblock {\em Environ. Health Perspect.} {\bf 2017}, {\em
  125},~097009.

\bibitem[Tornero-Velez et~al.(2012)Tornero-Velez, Davis, Scollon, Starr,
  Setzer, Goldsmith, Chang, Xue, Zartarian, De~Vito,
  et~al.]{tornero2012pharmacokinetic}
...
\newblock {\em Toxicol. Sci.} {\bf 2012}, {\em 130},~33--47.

\bibitem[Isaacs et~al.(2014)Isaacs, Glen, Egeghy, Goldsmith, Smith, Vallero,
  Brooks, and Grulke]{isaacs2014sheds}
...
\bibitem[Barr et~al.(2010)Barr, Olsson, Wong, Udunka, Baker, Whitehead~Jr,
  Magsumbol, Williams, and Needham]{barr2010urinary}
...
\newblock Urinary concentrations of metabolites of pyrethroid insecticides in
  ...
  1999--2002.
\newblock {\em Environ. Health Perspect.} {\bf 2010}, {\em
  118},~742--748.

\bibitem[Quindroit et~al.(2021)Quindroit, Cr{\'e}pet, and
  Brochot]{quindroit2021estimating}
...
\newblock {\em Environ. Res.} {\bf 2021}, {\em 192},~110281.

\bibitem[Tarazona et~al.(2022)Tarazona, Cattaneo, Niemann, Pedraza-Diaz,
  Gonz{\'a}lez-Caballero, de~Alba-Gonzalez, Ca{\~n}as, Dominguez-Morueco,
  Esteban-L{\'o}pez, Casta{\~n}o, et~al.]{tarazona2022tiered}
...
\newblock {\em Toxics} {\bf 2022}, {\em 10},~451.

\bibitem[Blount et~al.(2007)Blount, Valentin-Blasini, Osterloh, Mauldin, and
  Pirkle]{blount2007perchlorate}
...
\bibitem[Sobus et~al.(2015)Sobus, DeWoskin, Tan, Pleil, Phillips, George,
  Christensen, Schreinemachers, Williams, Hubal, et~al.]{sobus2015uses}
...
\newblock {\em Environ. Health Perspect.} {\bf 2015}, {\em
  123},~919--927.

\bibitem[Apel et~al.(2023)Apel, Lamkarkach, Lange, Sissoko, David, Rousselle,
  Schoeters, and Kolossa-Gehring]{apel2023human}
...
\newblock {\em Int. J. Hyg. Environ. Health} {\bf
  2023}, {\em 248},~114097.

\bibitem[Morgan et~al.(2007)Morgan, Sheldon, Croghan, Jones, Chuang, and
  Wilson]{morgan2007observational}
...
\newblock An observational study of 127 preschool children at their homes and
  ...
  exposure.
\newblock {\em Environ. Res.} {\bf 2007}, {\em 104},~266--274.
\newpage
\bibitem[Trunnelle et~al.(2014)Trunnelle, Bennett, Tulve, Clifton, Davis,
  Calafat, Moran, Tancredi, and Hertz-Picciotto]{trunnelle2014urinary}
...
\bibitem[Aylward et~al.(2017)Aylward, Hays, and Zidek]{aylward2017variation}
...
\bibitem[Egeghy and Lorber(2011)]{egeghy2011assessment}
Egeghy, P.P.; Lorber, M.
...
\bibitem[Lin et~al.(2023)Lin, Morozov, Kadry, Caffrey, and
  Chou]{lin2023reconstructing}
...
\newblock {\em Chemosphere} {\bf 2023}, {\em 331},~138798.

\bibitem[Wambaugh et~al.(2013)Wambaugh, Setzer, Reif, Gangwal,
  Mitchell-Blackwood, Arnot, Joliet, Frame, Rabinowitz, Knudsen,
  et~al.]{wambaugh2013high}
...
\newblock {\em Environ. Sci. Technol.} {\bf 2013}, {\em
  47},~8479--8488.

\bibitem[Stanfield et~al.(2022)Stanfield, Setzer, Hull, Sayre, Isaacs, and
  Wambaugh]{stanfield2022bayesian}
...
\bibitem[Ring et~al.(2018)Ring, Arnot, Bennett, Egeghy, Fantke, Huang, Isaacs,
  Jolliet, Phillips, Price, et~al.]{ring2018consensus}
Ring, C.L.; Arnot, J.A.; Bennett, D.H.; Egeghy, P.P.; Fantke, P.; Huang, L.;
  Isaacs, K.K.; Jolliet, O.; Phillips, K.A.; Price, P.S.;  et~al.
\newblock {Consensus modeling of median chemical intake for the US
  population-based on predictions of exposure pathways}.
\newblock {\em Environ. Sci. Technol.} {\bf 2018}, {\em
  53},~719--732.

\bibitem[Tan et~al.(2006)Tan, Liao, Conolly, Blount, Mason, and
  Clewell]{tan2006use}
...
\bibitem[Allen et~al.(2007)Allen, Eric~Hack, and Clewell]{allen2007use}
...
\newblock Use of Markov Chain Monte Carlo analysis with a physiologically-based
  ...
  childbearing age.
\newblock {\em Risk Anal. Int. J.} {\bf 2007}, {\em
  27},~947--959.

\bibitem[Lyons et~al.(2008)Lyons, Yang, Mayeno, and
  Reisfeld]{lyons2008computational}
...
\newblock Computational toxicology of chloroform: Reverse dosimetry using
  ...
  biomonitoring data.
\newblock {\em Environ. Health Perspect.} {\bf 2008}, {\em
  116},~1040--1046.

\bibitem[Moreau et~al.(2017)Moreau, Leonard, Phillips, Campbell, Pendse,
  Nicolas, Phillips, Yoon, Tan, Smith, et~al.]{moreau2017using}
...
\newblock {\em Chemosphere} {\bf 2017}, {\em 184},~1194--1201.

\bibitem[Quindroit et~al.(2019)Quindroit, Beaudouin, and
  Brochot]{quindroit2019estimating}
Quindroit, P.; Beaudouin, R.; Brochot, C.
\newblock {Estimating the cumulative human exposures to pyrethroids by combined
  multi-route PBPK models: Application to the French population}.
\newblock {\em Toxicol. Lett.} {\bf 2019}, {\em 312},~125--138.

\bibitem[Hays et~al.(2007)Hays, Becker, Leung, Aylward, and
  Pyatt]{hays2007biomonitoring}
...
\newblock {\em Regul. Toxicol. Pharmacol.} {\bf 2007}, {\em
  47},~96--109.

\bibitem[Aylward et~al.()Aylward, Kirman, Adgate, {McKenzie}, and
  Hays]{aylward_interpreting_2012}
...
\newblock Interpreting variability in population biomonitoring data: Role of
  elimination kinetics. \emph{\hl{J. Expo. Sci. Environ. Epidemiol.} %MDPI: Newly added  information. Please confirm. REPLY: Confirm.
} \textbf{\hl{2012}},
\newblock {\em 22},~\hl{398--408.} %MDPI: We deleted ``Number: 4 Publisher: Nature Publishing Group.'', please confirm. REPLY: Confirm.


\bibitem[Leng et~al.(1997)Leng, K{\"u}hn, and Idel]{leng1997biological}
...
\newblock {\em Sci. Total Environ.} {\bf 1997}, {\em
  199},~173--181.

\bibitem[Woollen et~al.()Woollen, Marsh, Laird, and
  Lesser]{woollen_metabolism_1992}
Woollen, B.H.; Marsh, J.R.; Laird, W.J.D.; Lesser, J.E.
\newblock The metabolism of cypermethrin in man: Differences in urinary
  metabolite profiles following oral and dermal administration. \emph{\hl{Xenobiotica} %MDPI: Newly added information. Please confirm. REPLY: Confirm.
} \textbf{\hl{1992}},
\newblock {\em 22},~983--991.

\bibitem[Sam and Jones(2012)]{sam2012biological} % REPLY: Add Reference for Figure A2
 Sam, C.; Jones, K.
...
\newblock{\em Toxicol. lett.} {\bf 2012}, {\em 213},~35--38.

\bibitem[Aylward et~al.()Aylward, Irwin, St-Amand, Nong, and
  Hays]{aylward_screening_level_2018}
...
\newblock Screening-level Biomonitoring Equivalents for tiered interpretation
  of urinary 3-phenoxybenzoic acid (3-{PBA}) in a risk assessment context. \emph{\hl{Regul. Toxicol. Pharmacol.} %MDPI: Newly added information. Please confirm. REPLY:Confirm.
}  \textbf{2018},
\newblock {\em 92},~29--38.

\bibitem[Scher et~al.(2007)Scher, Alexander, Adgate, Eberly, Mandel,
  Acquavella, Bartels, and Brzak]{scher2007agreement}
...
\bibitem[Song et~al.(2019)Song, Moreau, Efremenko, Lake, Wu, Bruckner, White,
  Osimitz, Creek, Hinderliter, et~al.]{song2019evaluation}
...
\newblock {\em Toxicol. Sci.} {\bf 2019}, {\em 169},~365--379.

\bibitem[Mallick et~al.(2020)Mallick, Moreau, Song, Efremenko, Pendse, Creek,
  Osimitz, Hines, Hinderliter, Clewell, et~al.]{mallick2020development}
...
\newblock {\em Toxicol. Sci.} {\bf 2020}, {\em 173},~86--99.

\bibitem[Mallick et~al.()Mallick, Song, Efremenko, Pendse, Creek, Osimitz,
  Hines, Hinderliter, Clewell, Lake, Yoon, and
  Moreau]{mallick_physiologically_2020}
...
\newblock Physiologically Based Pharmacokinetic Modeling in Risk Assessment:
  Case Study With Pyrethroids. \emph{\hl{Toxicol. Sci.} %MDPI: Newly added information. Please confirm. REPLY: Confirm.
} \textbf{\hl{2020}},
\newblock {\em 176},~\hl{460--469.} %MDPI: We deleted ``Publisher: Oxford Academic.'', please confirm REPLY: Confirm.



\bibitem[Mirfazaelian et~al.()Mirfazaelian, Kim, Anand, Kim, Tornero-Velez,
  Bruckner, and Fisher]{mirfazaelian_development_2006}
...
\newblock Development of a Physiologically Based Pharmacokinetic Model for
  Deltamethrin in the Adult Male Sprague-Dawley Rat. \emph{\hl{Toxicol. Sci.} %MDPI: Newly added information. Please confirm. REPLYL Confirm.
} \textbf{\hl{2006}},
\newblock {\em 93},~\hl{432--442.} %MDPI: We deleted ``Publisher: Oxford Academic.'', please confirm. REPLY: Confirm.


\bibitem[Tornero-Velez et~al.(2010)Tornero-Velez, Mirfazaelian, Kim, Anand,
  Kim, Haines, Bruckner, and Fisher]{tornero2010evaluation}
Tornero-Velez, R.; Mirfazaelian, A.; Kim, K.B.; Anand, S.S.; Kim, H.J.; Haines,
  W.T.; Bruckner, J.V.; Fisher, J.W.
\newblock {Evaluation of deltamethrin kinetics and dosimetry in the maturing
  rat using a PBPK model}.
\newblock {\em Toxicol. Appl. Pharmacol.} {\bf 2010}, {\em
  244},~208--217.

\bibitem[Beaudouin et~al.(2010)Beaudouin, Micallef, and
  Brochot]{beaudouin2010stochastic}
...
\newblock A stochastic whole-body physiologically based pharmacokinetic model
  ...
  the human lifespan.
\newblock {\em Regul. Toxicol. Pharmacol.} {\bf 2010}, {\em
  57},~103--116.

\bibitem[Leng et~al.(1997)Leng, Leng, K{\"u}hn, and Lewalter]{leng1997human}
...
\newblock {\em Xenobiotica} {\bf 1997}, {\em 27},~1273--1283.

\bibitem[Ratelle et~al.(2015{\natexlab{a}})Ratelle, C{\^o}t{\'e}, and
  Bouchard]{ratelle2015toxicokinetics}
Ratelle, M.; C{\^o}t{\'e}, J.; Bouchard, M.
\newblock Toxicokinetics of permethrin biomarkers of exposure in orally exposed
  volunteers.
\newblock {\em Toxicol. Lett.} {\bf 2015}, {\em 232},~369--375.

\bibitem[Ratelle et~al.(2015{\natexlab{b}})Ratelle, Cot{\'e}, and
  Bouchard]{ratelle2015time}
...
\newblock {\em J. Appl. Toxicol.} {\bf 2015}, {\em 35},~1586--1593.

\bibitem[Dionisio et~al.(2018)Dionisio, Phillips, Price, Grulke, Williams,
  Biryol, Hong, and Isaacs]{dionisio2018chemical}
...
\newblock {\em Sci. Data} {\bf 2018}, {\em 5},~\hl{180125.} %MDPI: We revised the article number. Please confirm. REPLY: Confirm.


\bibitem[Wambaugh and Rager(2022)]{wambaugh2022exposure}
...
\bibitem[Faure et~al.()Faure, Noisel, Werry, Karthikeyan, Aylward, and
  St-Amand]{faure_evaluation_2020}
...
\newblock Evaluation of human biomonitoring data in a health risk based
  ...
  Health Measures Survey.  \emph{\hl{Int. J. Hyg. Environ. Health} %MDPI: Newly added  information. Please confirm. REPLY: Confirm.
}  \textbf{\hl{2020}},
\newblock {\em 223},~267--280.

\bibitem[Wolansky et~al.()Wolansky, Gennings, and
  Crofton]{wolansky_relative_2006}
Wolansky, M.J.; Gennings, C.; Crofton, K.M.
\newblock Relative Potencies for Acute Effects of Pyrethroids on Motor Function
  in Rats. \emph{\hl{Toxicol. Sci.} %MDPI: Newly added information. Please confirm. REPLY: Confirm.
} \textbf{\hl{2006}},
\newblock {\em 89},~\hl{271--277.} %MDPI: We deleted ``Publisher: Oxford Academic.'', please confirm REPLY: Confirm.


\bibitem[{U.S. EPA}(2018)]{us2018der}
{U.S. EPA}.
...
\newblock Available online:
  \url{https://www.regulations.gov/document/EPA-HQ-OPP-2008-0331-0064}\linebreak \hl{(accessed~on 3 March 2023).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020. REPLY: Added.


\bibitem[{Shao Kan} and {Shapiro Andrew J.}(2018)]{shao_kan_web_2018}
{Shao, K}.; {Shapiro, A.J.}
\newblock A {Web}-{Based} {System} for {Bayesian} {Benchmark} {Dose}
  {Estimation}.
\newblock {\em Environ. Health Perspect.} {\bf 2018}, {\em
  126},~\hl{017002.} %MDPI: We deleted ``Publisher: Environmental Health Perspectives.'', please confirm REPLY: Confirm.


\bibitem[Beauvais et~al.(2010)Beauvais, Silva, and Powell]{beauvais_human_2010}
...
\bibitem[Bessems et~al.(2017)Bessems, Paini, Gajewska, and
  Worth]{bessems_margin_2017}
...
\newblock {\em Toxicology} {\bf 2017}, {\em 392},~119--129.

\bibitem[Scollon et~al.(2011)Scollon, Starr, Crofton, Wolansky, DeVito, and
  Hughes]{scollon_correlation_2011}
...
\newblock {\em Toxicology} {\bf 2011}, {\em 290},~1--6.

\bibitem[Bois()]{bois_gnu_2009}
Bois, F.Y.
\newblock {GNU} {MCSim}: Bayesian statistical inference for {SBML}-coded
  systems biology models. \emph{\hl{Bioinformatics} %MDPI: Newly added  information. Please confirm. REPLY: Confirm.
} \textbf{\hl{2009}},
\newblock {\em 25},~1453--1454.

\bibitem[Gelman and Rubin(1992)]{gelman1992inference}
Gelman, A.; Rubin, D.B.
\newblock Inference from iterative simulation using multiple sequences.
\newblock {\em Stat. Sci.} {\bf 1992}, {\em 7},~457--472.

\bibitem[Stanfield et~al.(2024)Stanfield, Setzer, Hull, Sayre, Isaacs, and
  Wambaugh]{stanfield2024characterizing}
Stanfield, Z.; Setzer, R.W.; Hull, V.; Sayre, R.R.; Isaacs, K.K.; Wambaugh,
  J.F.
\newblock Characterizing Chemical Exposure Trends from NHANES Urinary
  Biomonitoring Data.
\newblock {\em Environ. Health Perspect.} {\bf 2024}, {\em
  132},~017009.

\bibitem[Wu et~al.(2013)Wu, Feng, Qi, Wang, Zheng, Chang, and
  Zhou]{wu2013urinary}
...
\newblock {\em Chemosphere} {\bf 2013}, {\em 90},~2705--2713.

\bibitem[{U.S. EPA}(2017)]{us2017deltamethrin}
{U.S. EPA}.
\newblock Deltamethrin. Draft Human Health Risk Assessment for Registration
  Review.  2017.
\newblock Available online:
  \url{https://www.regulations.gov/document/EPA-HQ-OPP-2009-0637-0036} \hl{(accessed~on 3 March 2023).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020. REPLY: Added.


\bibitem[Desai et~al.(2024)Desai, Wilson, Ji, Sautner, Prussia, Demchuk,
  Mumtaz, and Ruiz]{desai_role_2024}
...
\newblock The role of simulation science in public health at the agency for
  ...
  decade.
\newblock {\em Toxics} {\bf 2024}, {\em 12},~\hl{811.} %MDPI: We removed ``Number: 11 Publisher: Multidisciplinary Digital Publishing Institute.'',please confirm. REPLY: Confirm.


\bibitem[Kissel et~al.()Kissel, Curl, Kedan, Lu, Griffith, Barr, Needham, and
  Fenske]{kissel_comparison_2005}
...
\newblock Comparison of organophosphorus pesticide metabolite levels in single
  ...
  Washington State. \emph{\hl{J.~Expo. Sci. Environ. Epidemiol.} %MDPI: Newly added information. Please confirm. REPLY: Confirm.
} \textbf{\hl{2005}},
\newblock {\em 15},~164--171.

\bibitem[{U.S. EPA}(2017{\natexlab{a}})]{us2017cyfluthrin}
{U.S. EPA}.
\newblock Cyfluthrin and Beta-Cyfluthrin. Draft Human Health Risk Assessment
  for Registration Review.  2017.
\newblock Available online:
  \url{https://www.regulations.gov/document/EPA-HQ-OPP-2010-0684-0102}\hl{ (accessed~on 3 March 2023).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020. refs. 67, 68, 69 are the same. REPLY: Added.


\bibitem[{U.S. EPA}(2017{\natexlab{b}})]{us2017permethrin}
{U.S. EPA}.
...
\bibitem[{U.S. EPA}(2011)]{us2011pyrethroid}
{U.S. EPA}.
...
\bibitem[{U.S. EPA}(2018)]{us2018cypermethrin}
{U.S. EPA}.
...
\bibitem[Wolansky et~al.(2009)Wolansky, Gennings, DeVito, and
  Crofton]{wolansky_marcelo_j_evidence_2009}
Wolansky, M.J.; Gennings, C.; DeVito, M.J.; Crofton, K.M.
\newblock Evidence for {dose}-{additive} {effects} of {pyrethroids} on {motor}
  {activity} in {rats}.
\newblock {\em Environ. Health Perspect.} {\bf 2009}, {\em
  117},~\hl{1563--1570.} %MDPI: We deleted ``Publisher: Environmental Health Perspectives.'', please confirm. REPLY: Confirm.


\bibitem[Arnot et~al.(2022)Arnot, Toose, Armitage, Sangion, Looky, Brown, Li,
  and Becker]{arnot_developing_2022}
...
\newblock {\em J. Expo. Sci. Environ. Epidemiol.} {\bf
  2022}, {\em 32},~\hl{877--884.} %MDPI: We deleted ``Number: 6 Publisher: Nature Publishing Group.'', please confirm. REPLY: Confirm.


\bibitem[Chiu and Rusyn()]{chiu_advancing_2018}
Chiu, W.A.; Rusyn, I.
\newblock Advancing chemical risk assessment decision-making with population
  variability data: Challenges and opportunities. \emph{\hl{Mamm. Genome} %MDPI: Newly added information. Please confirm. REPLY: Confirm.
} \textbf{\hl{2018}},
\newblock {\em 29},~182--189.

\bibitem[Thépaut et~al.(2024)Thépaut, Bisson, Brochot, Personne, Appenzeller,
  Zaros, Chardon, and Zeman]{thepaut_pbpk_2024}
Thépaut, E.; Bisson, M.; Brochot, C.; Personne, S.; Appenzeller, B.M.R.;
  Zaros, C.; Chardon, K.; Zeman, F.
\newblock {PBPK} modeling to support risk assessment of pyrethroid exposure in
  {French} pregnant women.
\newblock {\em Environ. Res.} {\bf 2024}, {\em 251},~118606.
